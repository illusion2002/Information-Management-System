...
class student:
    ...
    #making frame 
        ...
        main_frame.place(x=10,y=40,width=1530,height=700)
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select department" or self.var_std_id.get()=="" or self.var_std_name.get()=="":
            ...
            try:
                ...
                for x in my_result:
                    id+=1
                my_cursor.execute("UPDATE student set Class=%s,Section=%s,Batch=%s,Name=%s,RollNumber=%s,Gender=%s,DOB=%s,PhoneNumber=%s,Email=%s,Address=%s,PhotoSample=%s where StudentId=%s",(
